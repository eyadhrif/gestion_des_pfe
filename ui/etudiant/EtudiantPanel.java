...
public class EtudiantPanel extends JPanel {
    ...
    private JPanel createHeaderPanel() {
        ...
        searchField.putClientProperty("JTextField.placeholderText", "Rechercher par nom, email ou classe...");
        searchField.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        searchField.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(ColorPalette.BORDER_COLOR, 1, true),
        ...
        JButton btnAdd = createActionButton("Nouveau", ColorPalette.PRIMARY_BLUE);
        JButton btnEdit = createActionButton("Modifier", ColorPalette.WARNING_AMBER);
        JButton btnDelete = createActionButton("Supprimer", ColorPalette.ERROR_RED);
        JButton btnRefresh = createActionButton("Actualiser", ColorPalette.TEXT_SECONDARY);
    ...
    private void styleTable(JTable table) {
        ...
        table.getColumnModel().getColumn(4).setPreferredWidth(120); // Classe
    }
    ...
    private void filterTable() {
        ...
        if (text.isEmpty()) {
            ...
            // Filter by multiple columns (nom, prénom, email, classe)
