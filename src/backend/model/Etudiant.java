...
public class Etudiant {
    ...
    private String pfeTitre; // New field for linked PFE
    ...
    public String getPfeTitre() { return pfeTitre; }
    public void setPfeTitre(String pfeTitre) { this.pfeTitre = pfeTitre; }
